...
function(csharp_add_project name)
    ...
    add_custom_target(
        ...
        -DCSHARP_CONFIGURE="${CSBUILD_CONFIGURE_FLAG}"
        ...
        COMMAND ${CSBUILD_EXECUTABLE} ${CSBUILD_BUILD_FLAGS} ${CSBUILD_${name}_CSPROJ} ${CSBUILD_CONFIGURE_ARG}${CSBUILD_CONFIGURE_FLAG}
