...
///
/// 
/// ros2 service call /object_manager/so spawn_object_interfaces/srv/SpawnObject "{obj_name: my_object_1, parent_frame: RobotAxisY, translation: {x: 0.0, y: 0.0, z: 0.0}, rotation: {x: 0.0, y: 0.0, z: 0.0, w: 0.0}, cad_data: //home/match-mover/Downloads/UFC.STL}"}
/// Step 1:
///         spwaw an object:
