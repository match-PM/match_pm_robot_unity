...
/// Step 7:
///         get informations:
///             ros2 service call object_manager_unity/get_info spawn_object_interfaces/srv/GetInfo
/// Step 8:
///         modify pose:
    ...
    void Start()
    {
        ...
        {                        
            if (ros2Node == null)
            {
                ...
                try
                {
                    GetInfoService = ros2Node.CreateService<getInfoReq, getInfoResp>("/object_manager_unity/get_info", GetInfo);
                }
                catch(Exception ex)
                {
