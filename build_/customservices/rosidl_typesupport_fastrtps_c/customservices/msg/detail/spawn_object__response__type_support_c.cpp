...
#include "customservices/msg/detail/spawn_object__response__rosidl_typesupport_fastrtps_c.h"
...
using _SpawnObject_Response__ros_msg_type = customservices__msg__SpawnObject_Response;
...
size_t get_serialized_size_customservices__msg__SpawnObject_Response(
  const void * untyped_ros_message,
...
static uint32_t _SpawnObject_Response__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_customservices__msg__SpawnObject_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_customservices
size_t max_serialized_size_customservices__msg__SpawnObject_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
static size_t _SpawnObject_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_customservices__msg__SpawnObject_Response(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, customservices, msg, SpawnObject_Response)() {
