...
#include "customservices/srv/detail/spawn_object__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const customservices::srv::SpawnObject_Request & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  customservices::srv::SpawnObject_Request & ros_message)
{
  // Member: obj_name
  cdr >> ros_message.obj_name;
...
{
  auto typed_message =
    static_cast<const customservices::srv::SpawnObject_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<customservices::srv::SpawnObject_Request *>(
    untyped_ros_message);
...
{
  return &customservices::srv::typesupport_fastrtps_cpp::_SpawnObject_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, customservices, srv, SpawnObject_Request)() {
  return &customservices::srv::typesupport_fastrtps_cpp::_SpawnObject_Request__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_customservices
cdr_serialize(
  const customservices::srv::SpawnObject_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: success
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  customservices::srv::SpawnObject_Response & ros_message)
{
  // Member: success
  {
    uint8_t tmp;
...
{
  auto typed_message =
    static_cast<const customservices::srv::SpawnObject_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<customservices::srv::SpawnObject_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &customservices::srv::typesupport_fastrtps_cpp::_SpawnObject_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, customservices, srv, SpawnObject_Response)() {
  return &customservices::srv::typesupport_fastrtps_cpp::_SpawnObject_Response__handle;
}
...
{
  return &customservices::srv::typesupport_fastrtps_cpp::_SpawnObject__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, customservices, srv, SpawnObject)() {
  return &customservices::srv::typesupport_fastrtps_cpp::_SpawnObject__handle;
}
