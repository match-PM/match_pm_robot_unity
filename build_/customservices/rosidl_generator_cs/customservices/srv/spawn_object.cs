...
public class SpawnObject_Request : MessageInternals, Message
{
  ...
  static SpawnObject_Request()
  {
    ...
    IntPtr nativelibrary = dllLoadUtils.LoadLibrary("customservices_srv_spawn_object__rosidl_typesupport_c");
    IntPtr native_get_typesupport_ptr = dllLoadUtils.GetProcAddress(nativelibrary, "customservices__srv__SpawnObject_Request_native_get_type_support");
    ...
    IntPtr native_create_native_message_ptr = dllLoadUtils.GetProcAddress(nativelibrary, "customservices__srv__SpawnObject_Request_native_create_native_message");
    ...
    IntPtr native_destroy_native_message_ptr = dllLoadUtils.GetProcAddress(nativelibrary, "customservices__srv__SpawnObject_Request_native_destroy_native_message");
    ...
    IntPtr native_read_field_obj_name_ptr =
      dllLoadUtils.GetProcAddress(nativelibrary, "customservices__srv__SpawnObject_Request_native_read_field_obj_name");
    ...
    IntPtr native_write_field_obj_name_ptr =
      dllLoadUtils.GetProcAddress(nativelibrary, "customservices__srv__SpawnObject_Request_native_write_field_obj_name");
    ...
    IntPtr native_read_field_parent_frame_ptr =
      dllLoadUtils.GetProcAddress(nativelibrary, "customservices__srv__SpawnObject_Request_native_read_field_parent_frame");
    ...
    IntPtr native_write_field_parent_frame_ptr =
      dllLoadUtils.GetProcAddress(nativelibrary, "customservices__srv__SpawnObject_Request_native_write_field_parent_frame");
    ...
    IntPtr native_read_field_translation_ptr =
      dllLoadUtils.GetProcAddress(nativelibrary, "customservices__srv__SpawnObject_Request_native_read_field_translation");
    ...
    IntPtr native_write_field_translation_ptr =
      dllLoadUtils.GetProcAddress(nativelibrary, "customservices__srv__SpawnObject_Request_native_write_field_translation");
    ...
    IntPtr native_read_field_rotation_ptr =
      dllLoadUtils.GetProcAddress(nativelibrary, "customservices__srv__SpawnObject_Request_native_read_field_rotation");
    ...
    IntPtr native_write_field_rotation_ptr =
      dllLoadUtils.GetProcAddress(nativelibrary, "customservices__srv__SpawnObject_Request_native_write_field_rotation");
    ...
    IntPtr native_read_field_cad_data_ptr =
      dllLoadUtils.GetProcAddress(nativelibrary, "customservices__srv__SpawnObject_Request_native_read_field_cad_data");
    ...
    IntPtr native_write_field_cad_data_ptr =
      dllLoadUtils.GetProcAddress(nativelibrary, "customservices__srv__SpawnObject_Request_native_write_field_cad_data");
...
public class SpawnObject_Response : MessageInternals, Message
{
  ...
  static SpawnObject_Response()
  {
    ...
    IntPtr nativelibrary = dllLoadUtils.LoadLibrary("customservices_srv_spawn_object__rosidl_typesupport_c");
    IntPtr native_get_typesupport_ptr = dllLoadUtils.GetProcAddress(nativelibrary, "customservices__srv__SpawnObject_Response_native_get_type_support");
    SpawnObject_Response.native_get_typesupport = (NativeGetTypeSupportType)Marshal.GetDelegateForFunctionPointer(
      native_get_typesupport_ptr, typeof(NativeGetTypeSupportType));

    IntPtr native_create_native_message_ptr = dllLoadUtils.GetProcAddress(nativelibrary, "customservices__srv__SpawnObject_Response_native_create_native_message");
    SpawnObject_Response.native_create_native_message = (NativeCreateNativeMessageType)Marshal.GetDelegateForFunctionPointer(
      native_create_native_message_ptr, typeof(NativeCreateNativeMessageType));

    IntPtr native_destroy_native_message_ptr = dllLoadUtils.GetProcAddress(nativelibrary, "customservices__srv__SpawnObject_Response_native_destroy_native_message");
    ...
    IntPtr native_read_field_success_ptr =
      dllLoadUtils.GetProcAddress(nativelibrary, "customservices__srv__SpawnObject_Response_native_read_field_success");
    ...
    IntPtr native_write_field_success_ptr =
      dllLoadUtils.GetProcAddress(nativelibrary, "customservices__srv__SpawnObject_Response_native_write_field_success");
