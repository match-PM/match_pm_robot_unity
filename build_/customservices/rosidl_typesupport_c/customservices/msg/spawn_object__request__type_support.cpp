...
static const _SpawnObject_Request_type_support_symbol_names_t _SpawnObject_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, customservices, msg, SpawnObject_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, customservices, msg, SpawnObject_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, customservices, msg, SpawnObject_Request)() {
  return &::customservices::msg::rosidl_typesupport_c::SpawnObject_Request_message_type_support_handle;
}
