...
static const _SpawnObject_Request_type_support_symbol_names_t _SpawnObject_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, customservices, srv, SpawnObject_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, customservices, srv, SpawnObject_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, customservices, srv, SpawnObject_Request)() {
  return &::customservices::srv::rosidl_typesupport_c::SpawnObject_Request_message_type_support_handle;
}
...
static const _SpawnObject_Response_type_support_symbol_names_t _SpawnObject_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, customservices, srv, SpawnObject_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, customservices, srv, SpawnObject_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, customservices, srv, SpawnObject_Response)() {
  return &::customservices::srv::rosidl_typesupport_c::SpawnObject_Response_message_type_support_handle;
}
...
static const _SpawnObject_type_support_symbol_names_t _SpawnObject_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, customservices, srv, SpawnObject)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, customservices, srv, SpawnObject)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, customservices, srv, SpawnObject)() {
  return &::customservices::srv::rosidl_typesupport_c::SpawnObject_service_type_support_handle;
}
